...
namespace LuaFramework
{
    public static class LuaHelper
    {
        ...
        {
            return AppFacade.Instance.GetManager<ObjectManager>(ManagerName.Object);
        }
        ...
        public static SpineManager GetSpineManager()
        {
            return AppFacade.Instance.GetManager<SpineManager>(ManagerName.Spine);
        }
