...
namespace LuaFramework {
    ...
    public class ResourceManager : Manager {
        ...
        //added by LY;
        public void LoadPrefab(string abName, string[] assetNames, LuaFunction func,int id) {
            LoadAsset<GameObject>(abName, assetNames, null, func, id);
        }
        ...
        /// 载入素材
        /// </summary>
        void LoadAsset<T>(string abName, string[] assetNames, Action<UObject[]> action = null, LuaFunction func = null,int argId = -1) where T : UObject {
        ...
        IEnumerator OnLoadAsset<T>(string abName) where T : UObject {
            ...
            for (int i = 0; i < list.Count; i++) {
                ...
                if (list[i].luaFunc != null) {
                    ...
                    if (list[i].argId > -1){
                        list[i].luaFunc.Call((object)result.ToArray(), list[i].argId);
                    }else {
