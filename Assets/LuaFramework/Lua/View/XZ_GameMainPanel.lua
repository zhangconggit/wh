...
setbaseclass(XZ_GameMainPanel, { BasePanel })

function XZ_GameMainPanel:InitPanel()
	logWarn("-----------------------------------------XZ_GameMainPanel")
	...
	self.imgReadyL = self:Child("imgHeadL/imgReadyL")
	self.imgReadyR = self:Child("imgHeadR/imgReadyR")
	self.imgReadyU = self:Child("imgHeadU/imgReadyU")
	self.imgReadyD = self:Child("imgHeadD/imgReadyD")
	...
	self.imgDingQue = self:Child("imgDingQue")
	self.btnWan = self:Child("imgDingQue/btnWan")
	self.btnTong = self:Child("imgDingQue/btnTong")
	self.btnTiao = self:Child("imgDingQue/btnTiao")

	self.imgdqueTongD 	= self:Child("imgHeadD/imgdqueTongD")
	self.imgdqueWanD 	= self:Child("imgHeadD/imgdqueWanD")
	self.imgdqueTiaoD 	= self:Child("imgHeadD/imgdqueTiaoD")

	self.imgdqueTongR = self:Child("imgHeadR/imgdqueTongR")
	self.imgdqueWanR = self:Child("imgHeadR/imgdqueWanR")
	self.imgdqueTiaoR = self:Child("imgHeadR/imgdqueTiaoR")

	self.imgdqueTongU = self:Child("imgHeadU/imgdqueTongU")
	self.imgdqueWanU = self:Child("imgHeadU/imgdqueWanU")
	self.imgdqueTiaoU = self:Child("imgHeadU/imgdqueTiaoU")

	self.imgdqueTongL = self:Child("imgHeadL/imgdqueTongL")
	self.imgdqueWanL = self:Child("imgHeadL/imgdqueWanL")
	self.imgdqueTiaoL = self:Child("imgHeadL/imgdqueTiaoL")
end