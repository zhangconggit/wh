...
module('GoldSingleSettlement_pb')


local GOLDSINGLESETTLEMENTRES = protobuf.Descriptor();
local GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD = protobuf.FieldDescriptor();
local GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD = protobuf.FieldDescriptor();
...
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.name = "settlementInfo"
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.full_name = ".GoldSingleSettlementRes.settlementInfo"
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.number = 1
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.index = 0
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.label = 3
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.has_default_value = false
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.default_value = {}
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.message_type = SETTLEMENTINFO
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.type = 11
GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD.cpp_type = 10

GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.name = "endType"
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.full_name = ".GoldSingleSettlementRes.endType"
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.number = 2
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.index = 1
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.label = 1
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.has_default_value = false
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.default_value = 0
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.type = 5
GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD.cpp_type = 1

GOLDSINGLESETTLEMENTRES.name = "GoldSingleSettlementRes"
GOLDSINGLESETTLEMENTRES.full_name = ".GoldSingleSettlementRes"
GOLDSINGLESETTLEMENTRES.nested_types = {}
GOLDSINGLESETTLEMENTRES.enum_types = {}
GOLDSINGLESETTLEMENTRES.fields = {GOLDSINGLESETTLEMENTRES_SETTLEMENTINFO_FIELD, GOLDSINGLESETTLEMENTRES_ENDTYPE_FIELD}
GOLDSINGLESETTLEMENTRES.is_extendable = false
GOLDSINGLESETTLEMENTRES.extensions = {}
...
GoldSingleSettlementRes = protobuf.Message(GOLDSINGLESETTLEMENTRES)
