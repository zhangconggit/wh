...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetObjectManager", GetObjectManager);
		...
		L.RegFunction("GetSpineManager", GetSpineManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetObjectManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			ObjectManager o = LuaFramework.LuaHelper.GetObjectManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetSpineManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.SpineManager o = LuaFramework.LuaHelper.GetSpineManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
