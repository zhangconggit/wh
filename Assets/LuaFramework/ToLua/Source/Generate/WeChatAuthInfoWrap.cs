...
public class WeChatAuthInfoWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(WeChatAuthInfo), typeof(System.Object));
		L.RegFunction("CreateFromJson", CreateFromJson);
		L.RegFunction("New", _CreateWeChatAuthInfo);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("refresh_token", get_refresh_token, set_refresh_token);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_refresh_token(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			string ret = obj.refresh_token;
			LuaDLL.lua_pushstring(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index refresh_token on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_refresh_token(IntPtr L)
	{
		object o = null;
