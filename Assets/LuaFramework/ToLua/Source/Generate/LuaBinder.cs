...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ObjectManagerWrap.Register(L);
		weChatFunctionWrap.Register(L);
		weChatUserInfoWrap.Register(L);
		WeChatAuthInfoWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		...
		LuaFramework_SpineManagerWrap.Register(L);
