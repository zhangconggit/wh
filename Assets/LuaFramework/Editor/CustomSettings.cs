...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(ObjectManager)),
        _GT(typeof(weChatFunction)),
        _GT(typeof(weChatUserInfo)),
        _GT(typeof(WeChatAuthInfo)),
        ...
        _GT(typeof(DG.Tweening.Core.TweenerCore<Vector3, Vector3,
       DG.Tweening.Plugins.Options.VectorOptions>)).SetWrapName("TweenerCoreV3V3VO").SetLibName("TweenerCoreV3V3VO"),
  };
