...
public class Packager
{
    ...
    static void HandleExampleBundle()
    {
        ...
        */
        ...
        //AddBuildMap("CreateRoom" + AppConst.ExtName,"*.prefab","Assets/LuaFramework/Examples/Builds/CreateRoom");

        //AddBuildMap("prompt_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/Prompt");
        //AddBuildMap("shared_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/Shared");
        AddBuildMap("audio" + AppConst.ExtName, "*.assets", "Assets/Art/Audio");
    ...
    static void BuildFileIndex()
    {
        ...
        string verFilePath = resPath + "/version.txt";
        if (File.Exists(verFilePath)) File.Delete(verFilePath);
        File.WriteAllText(verFilePath, "ver=" + AppConst.version);
