...
public class NewBehaviourScript : MonoBehaviour {
    ...
    [System.Serializable]
    public enum PlatformThis{
        SinaWeibo= PlatformType.SinaWeibo,
        TencentWeibo = PlatformType.TencentWeibo,
        QQ=PlatformType.QQ,
    ...
    //分享
    public void OnShareClick(int pla)
    {
        ...
        shareSdk.ShowShareContentEditor((PlatformType)pla, content);                 //指定平台直接分享
    }
    ...
    //授权
    public void OnAuthClick(int pla)
    {
        //请求QQ授权//请求这个授权是为了获取用户信息来第三方登录
        shareSdk.Authorize((PlatformType)pla);
    }
