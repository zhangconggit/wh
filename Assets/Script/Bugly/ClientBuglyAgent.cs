...
public class ClientBuglyAgent : MonoBehaviour
{

    private string BuglyAppIDForiOS = String.Empty;
    private string BuglyAppIDForAndroid = String.Empty;
    ...
    void Start()
    {
        BuglyAgent.PrintLog(LogSeverity.LogInfo, "Client Start()");
